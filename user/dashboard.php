    ...
    <div class="container">
            ...
            <div class="col-lg-11 info-panel">
                <div class="row">
                    <div class="col-lg">
                        <img src="">
                        <h4>Beranda</h4>
                        <p>Halaman Utama Staff/Pegawai</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-11 panel">
                <div class="row">
                    <div class="col-lg">
                        <h3>Selamat Datang, Staff/Pegawai <br> di Sistem Pendukung Keputusan Tingkat Pelayanan Pada Puskesmas dengan kombinasi Metode AHP (Analytical Hierarchy Process) dan SAW (Simple Additive Weighting)</h3>
                    </div>
                </div>
            </div>
        </div>
