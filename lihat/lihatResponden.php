            ...
            <div class="col-lg-11">
                <div class="row">
                    <div class="col-lg user">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    die("Gagal! Data tidak ditemukan");
                                }
                                $CR = mysqli_query($conn, "Select * from kriteria");
                                while ($C = mysqli_fetch_array($CR)) {
                                    $nCR[] = $C['kriteria'];
                                }
                                $data = mysqli_query($conn, "Select kuesioner.C1 as C1, kuesioner.C2 as C2, kuesioner.C3 as C3, kuesioner.C4 as C4, kuesioner.C5 as C5, kuesioner.C6 as C6, kuesioner.C7 as C7, kuesioner.C8 as C8, kuesioner.responden as responden, alternatif.alternatif as namaAlternatif from kuesioner inner join alternatif on kuesioner.alternatif = alternatif.kode where kuesioner.id = '$id'");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td>Pelayanan</td>
                                        <td><?php echo $d['namaAlternatif'] ?></td>
                                    </tr>
                                    <tr>
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="../admin/kuesioner.php">Kembali</a>
                    </div>
                </div>
            </div>
