        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link" href="analisaKriteria.php">Analisa Kriteria</a>
                    <a class="nav-item nav-link" href="analisa.php">Hasil Analisa</a>
                    <a class="nav-item btn btn-danger tombol" href="login.php">Logout</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="col-lg-11 info-panel">
                <div class="row">
                    <div class="col-lg">
                        <img src="">
                        <h4>Kriteria</h4>
                        <p>Halaman Administrator Kriteria</p>
                    </div>
                </div>
            </div>
        </div>
