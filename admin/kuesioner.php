            ...
            <div class="col-lg-11 info-panel">
                <div class="row">
                    <div class="col-lg">
                        <img src="">
                        <h4>Kuesioner</h4>
                        <p>Halaman Administrator Kuesioner</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-11">
                <div class="row">
                    <div class="col-lg user">
                        <div class="row">
                            <div class="col">
                                <!-- Mencari berdasarkan alternatif -->
                                <form action="kuesioner.php" method="GET">
                                    <div class="input-group mb-3 ml-6">
                                        <select class="form-control" name="cari">
                                            <option selected>Cari Berdasarkan Alternatif</option>
                                            <?php
                                            $data = mysqli_query($conn, "Select * from alternatif ");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                        ...
                                        <input class="btn btn-primary btn-block col-lg-2 ml-2" type="submit" value="Cari">
                                    </div>
                                </form>
                            </div>
                            <div class="col">
                                <form action="kuesioner.php" method="GET">
                                    <div class="input-group mb-3 ml-6">
                                        <input type="text" name="cariNama" class="form-control" value="Cari Berdasarkan Nama">
                                        <input class=" btn btn-primary btn-block col-lg-2 ml-2" type="submit" value="Cari">
                                    </div>
                                </form>
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                // Mencari data berdasarkan alternatif dan Nama
                                if (isset($_GET['cari'])) {
                                    $cari = $_GET['cari'];
                                    $data = mysqli_query($conn, "Select kuesioner.responden as nama,kuesioner.id as idKuesioner, alternatif.alternatif as pelayanan from kuesioner inner join alternatif on kuesioner.alternatif = alternatif.kode where kuesioner.alternatif like '%" . $cari . "%'");
                                } else if (isset($_GET['cariNama'])) {
                                    $cari = $_GET['cariNama'];
                                    $data = mysqli_query($conn, "Select kuesioner.responden as nama,kuesioner.id as idKuesioner, alternatif.alternatif as pelayanan from kuesioner inner join alternatif on kuesioner.alternatif = alternatif.kode where kuesioner.responden like '%" . $cari . "%'");
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-primary btn-sm" href="../lihat/lihatResponden.php?id=<?php echo $d['idKuesioner']; ?>">Lihat</a>
                                            <a class="btn btn-outline-danger btn-sm" href="../hapus/hapusResponden.php?id=<?php echo $d['idKuesioner']; ?>">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
