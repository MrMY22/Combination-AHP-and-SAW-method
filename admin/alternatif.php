                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-warning btn-sm" href="../edit/EditAlternatif.php?id=<?php echo $d['id']; ?>">Edit</a>
                                            <a class="btn btn-outline-danger btn-sm" href="../hapus/hapusAlternatif.php?id=<?php echo $d['id']; ?>">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
