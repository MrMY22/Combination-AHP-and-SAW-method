                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-primary btn-sm" href="../lihat/lihatUser.php?id=<?php echo $d['id']; ?>">Lihat</a>
                                            <a class="btn btn-outline-warning btn-sm" href="../edit/EditUser.php?id=<?php echo $d['id']; ?>">Edit</a>
                                            <a class="btn btn-outline-danger btn-sm" href="../hapus/hapusUser.php?id=<?php echo $d['id']; ?>">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
