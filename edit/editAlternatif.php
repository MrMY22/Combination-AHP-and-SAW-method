            ...
            <div class="col-lg-11 info-panel">
                <div class="row">
                    <div class="col-lg">
                        <img src="">
                        <h4>Alternatif</h4>
                        <p>Halaman Administrator Alternatif</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 akun">
                        ...
                        if (isset($_POST['tombol'])) {
                            ...
                            mysqli_query($conn, "insert into alternatif values ('','$kode','$alternatif')");
                            mysqli_query($conn, "insert into ranking values ('$kode','0')");
                            mysqli_query($conn, "insert into keputusan values ('$kode','0','0','0','0','0','0','0','0')");
                        ...
                        <!-- Kode Alternatif Otomatis -->
                        <?php
                        $data = mysqli_query($conn, "Select max(kode) as kodeTerbesar from alternatif ");
                        $d = mysqli_fetch_array($data);
                        $kodeAlternatif = $d['kodeTerbesar'];

                        $urutan = (int) substr($kodeAlternatif, 1, 1);
                        $urutan++;

                        $huruf = "A";
                        $kodeAlternatif = $huruf . $urutan;
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="kode" class="form-control" value="<?php echo $kodeAlternatif ?>" readonly>
                    ...
                    <div class="col-lg user">
                        <?php
                        $id = $_GET['id'];
                        $data = mysqli_query($conn, "Select * from alternatif where id='$id'");
                        while ($d = mysqli_fetch_array($data)) {
                        ?>
                            <h5>Edit Data Alternatif</h5>
                            <form method="POST" action="prosesAlternatif.php">
                                <span>Kode</span>
                                <div class="input-group mb-3">
                                    <input type="hidden" name="id" value="<?php echo $d['id']; ?>" class="form-control">
                                    <input type="text" name="kode" value="<?php echo $d['kode']; ?>" class="form-control" readonly>

                                </div>
                                <span>Alternatif</span>
                                <div class="input-group mb-3">
                                    <input type="text" name="alternatif" value="<?php echo $d['alternatif']; ?>" class="form-control" required>

                                </div>
                                <div class="row">
                                    <div class="col">
                                        <a class="btn btn-outline-primary btn-sm" href="../admin/alternatif.php">Kembali</a>
