                ...
                <div class="navbar-nav ml-auto">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu isi-dropdown" aria-labelledby="dropdownMenuButton">
                            <a href="analisaKriteria.php" class="../admin/dropdown-item">Analisa Kriteria metode AHP</a>
                    ...
                    <div class="col-lg user">
                        ...
                        ?>
                            ...
                            <form method="POST" action="prosesKriteria.php">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="kriteria" value="<?php echo $d['kriteria']; ?>" class="form-control" required>
                                </div>
                                <span>Tipe</span>
                                <div class="input-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a class="btn btn-outline-primary btn-sm" href="../admin/analisaKriteria.php">Kembali</a>
